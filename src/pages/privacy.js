...
import { Section, Heading, Text, ProfileWrapper } from "../styles/pages/"

class PrvacyPage extends React.Component {
  render() {
    return (
      <Fragment>
        <GlobalStyle />
        ...
        <Section id="privacy">
          ...
          <Text maxWidth="70rem" margin="0 auto">
            ...
            <p>
              ...
              our Terms and Conditions, which is accessible at Clowny - Scare
              Prank unless otherwise defined in this Privacy Policy.
            </p>{" "}
            <p>
            ...
            <p>
              ...
              do not hesitate to contact me at appclowny@gmail.com.
            </p>{" "}
            <p />
          </Text>
        </Section>
